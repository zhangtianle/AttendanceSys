...
<body style="width:100%;height:98%;margin:0;padding:1px">
	...
	<div id="tb" style="height:auto;margin:0";background-color:"#CCC">
		<a href="addStu.do" class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true">新增学生</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			data-options="iconCls:'icon-remove',plain:true"
			onclick="return delscfm()">删除</a>
		<div id="search" style="padding:2px;font-size:12px;">
			<span>学生姓名:</span><input id="name"
				style="line-height:20px;border:1px solid #ccc">&nbsp;&nbsp;&nbsp;&nbsp;
			<span>卡号:</span><input id="cardID"
	...
	<table id="dg" style="width:100%;height:97%"
		data-options="method:'get',toolbar:'#tb'"></table>
